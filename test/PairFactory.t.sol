...
contract PairFactoryTest is Test {
    ...
    function _computeCreate2Address(address factory, address token0, address token1)
        internal
        pure
        returns (address predicted)
    {
        ...
        bytes32 digest = keccak256(abi.encodePacked(bytes1(0xff), factory, salt, initCodeHash));
    ...
    function testCreatePair() public {
        ...
        address expectedPair = _computeCreate2Address(address(pairFactory), token0, token1);
